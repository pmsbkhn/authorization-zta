...
func edgeSettle(aal string, amount int) map[string]any {
	return map[string]any{
		...
		"action":   map[string]any{"name": "wallet:settle", "properties": map[string]any{"method": "POST"}},
		"resource": map[string]any{"type": "wallet:account", "id": "acc-1", "properties": map[string]any{"amount": amount, "currency": "VND"}},
